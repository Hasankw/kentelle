      ...
      <div className="relative w-full h-80 md:h-96 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/skin-quiz" className="px-8 py-3 bg-brand-accent text-brand-navy rounded text-xs font-heading font-bold uppercase tracking-widest hover:bg-brand-accent/85 transition-colors">Find My Routine</Link>
