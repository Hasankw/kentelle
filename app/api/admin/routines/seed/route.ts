...
const ROUTINES = [
  ...
  },
  {
    ...
    tips: {
      ...
      education: [
        { label: "Dehydrated & Dead Skin Buildup", content: "When skin lacks water or cellular turnover slows, it looks tight, rough, and flaky. Sweep away dead cell buildup and deeply replenish cellular hydration to instantly restore smoothness and clarity." },
        { label: "Hyperpigmentation & Ageing Dullness", content: "Sun exposure, collagen loss, and deep cellular slowdown cause the complexion to look dark, patchy, and less firm. Accelerate cell turnover with targeted actives to fade dark spots, smooth wrinkles, and bring back a natural, youthful glow. Advanced actives accelerate cellular renewal to rapidly fade pigment, smooth fine lines, and revive your natural luminance." },
        { label: "Oily, Congested & Sensitive", content: "Excess oil, blocked pores, or a damaged skin barrier leave the skin looking greasy yet red, tired, and irritated. Balance oil production, unblock pores, and use soothing, bio-compatible nutrients to calm inflammation and repair your natural defense system." },
      ],
      items: [
        { label: "The Skin Prep", content: "Condition your skin for 6 weeks prior to IPL, Laser, Deep Peels, or Cosmetic Injectables to optimize cellular health, enhance your clinical results, and minimize post-procedure complications." },
        { label: "Post-Treatment Care", content: "Stop this active routine for 7–15 days after cosmetic treatments (or until fully healed). Switch to our soothing Everyday Essential or Skin Nutrients routine during this healing phase." },
        { label: "Start Slow", content: "When introducing highly active formulas like Retinol, Retinal, or Glyco-10, start with just one application per week and slowly increase frequency as your skin matrix builds tolerance." },
        { label: "Professional Help", content: "For deep, stubborn congestion or active acne, professional intervention is best. Pair your home care by booking in for extractions or microdermabrasion at your preferred dermal clinic." },
      ],
    },
  },
  {
  ...
  {
    title: "Oily, Combination & Acne-Prone Skin Facial Regime",
    slug: "oily-skin",
    tagline: "The pro-dermal routine to regulate excess sebum, clear deep congestion, and reveal a refined, shine-free 'glass skin' finish.",
    category: "routine",
    sortOrder: 4,
    steps: [
      {
        ...
        description: "Deep purification. For normal-to-oily skin, the Fruit Enzyme Cleanser provides a deep, enzymatic clean without stripping the barrier. For true oily or heavily congested skin, switch to the G Biomed Cleanser for advanced glycolic purification.",
      },
      {
        number: 2,
        name: "TONE",
        choices: "Vitamin B Toner (Day & Night).",
        description: "Balance and prep. A targeted step to regulate excess oil production, strengthen the skin barrier, and prepare the skin to absorb high-performance active treatments.",
      },
      {
        number: 3,
        name: "SERUM",
      ...
      },
      {
        ...
        subtitle: "The Game Changer",
        choices: "Glyco-10 (AM) | Retinol/Retinal alternate with UMMF Correcting Serum (PM).",
        description: "Resurface and renew. Shed dead skin cells and stimulate collagen while UMMF targets uneven tone and pigmentation for ultimate radiance. Application Note: Due to the specific formulation of the Retinal, always apply it before your serum step at night to ensure optimal absorption and efficacy.",
      },
      {
        number: 5,
        name: "ANTIOXIDANT",
      ...
      },
      {
        ...
        name: "MOISTURISE",
        choices: "Day Care, Night Care Moisturiser, Day Beauty Radiant, Night Beauty Repair, or Aqua Moisturiser (Day & Night).",
        description: "Seal and heal. Provide the necessary nourishment to support the skin's renewal process. Application Note: If the skin experiences dryness after using the Glycolic & Retinal, transition to the Day Care and Night Care Moisturiser to provide deeper nourishment instead of using the lightweight Aqua Moisturiser.",
      },
      {
        number: 7,
        name: "PROTECTION",
    ...
    tips: {
      suitability: "Best for: Oily, Blocked Pores, Acne-Prone, Oily-Combination Skin.",
      items: [
