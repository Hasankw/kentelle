...
export default function ReviewsError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="max-w-5xl mx-auto px-4 py-20 text-center">
      ...
      <button
        onClick={reset}
        className="px-6 py-2.5 bg-brand-accent text-brand-navy rounded text-xs font-heading font-bold uppercase tracking-widest hover:bg-brand-accent/85 transition-colors"
      >
        Try Again
      </button>
    </div>
